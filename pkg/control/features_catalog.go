...
var featureDefinitions = []featureDefinition{
	...
	{ID: "logging.clean_action", Category: "logging", Label: "Clean action logging", Description: "Record clean actions in the configured clean log channel.", SupportsGuildOverride: true, GlobalEditableFields: []string{"enabled"}, GuildEditableFields: []string{"enabled", "channel_id"}, LogEvent: discordlogging.LogEventCleanAction},
