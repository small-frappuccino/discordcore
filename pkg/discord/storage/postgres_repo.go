...
func (r *PostgresFeatureRepo) FetchAllActive(ctx context.Context) ([]GuildFeatureConfig, error) {
	...
	configs := make([]GuildFeatureConfig, 0, 1000)

	for rows.Next() {
		var cfg GuildFeatureConfig
