...
Consolidado de:
- `notes!!/discordcore-home-ui-rules-qotd-followup__needs-revalidation.txt`
- `notes!!/discordcore-ui-dashboard-drift-findings__open-implementation.txt`
- `notes!!/discordcore-ui-moderation-findings__open-implementation.txt`
...
- Simplificar a `ModerationPage` para o padrao de `direct settings`.
