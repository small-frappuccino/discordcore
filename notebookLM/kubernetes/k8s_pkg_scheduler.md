# Domain Architecture: pkg/scheduler
...
│       ├── backoff_queue.go
│       ├── nominator.go
│       ├── pending_pod_group_pods.go
│       ├── scheduling_queue.go
│       ├── testing.go
│       └── unschedulable_entities.go
├── framework
│   ├── api_calls
│   │   ├── api_calls.go
│   │   ├── pod_binding.go
...
// === FILE: references!/kubernetes/pkg/scheduler/backend/queue/scheduling_queue.go ===
```go
/*
