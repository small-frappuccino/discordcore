# Domain Architecture: pkg/controller
...
├── scheduling
│   └── podgroupprotection
│       └── podgroup_protection_controller.go
├── serviceaccount
│   ├── config
│   │   ├── v1alpha1
│   │   │   ├── conversion.go
...
│   │   │       └── selinux_label.go
│   │   ├── translator
│   │   │   └── selinux_translator.go
│   │   ├── metrics.go
│   │   ├── selinux_warning_controller.go
│   │   └── volumehost.go
│   ├── vacprotection
...
// === FILE: references!/kubernetes/pkg/controller/garbagecollector/garbagecollector.go ===
```go
/*
