# Domain Architecture: cmd/test2json
...
// === FILE: references!/go/src/cmd/test2json/main.go ===
```go
...
// === FILE: references!/go/src/cmd/test2json/signal_notunix.go ===
```go
...
// === FILE: references!/go/src/cmd/test2json/signal_unix.go ===
```go
// Copyright 2022 The Go Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
