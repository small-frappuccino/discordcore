# Domain Architecture: cmd/compile/internal/importer
...
// === FILE: references!/go/src/cmd/compile/internal/importer/gcimporter.go ===
```go
...
// === FILE: references!/go/src/cmd/compile/internal/importer/support.go ===
```go
...
// === FILE: references!/go/src/cmd/compile/internal/importer/ureader.go ===
```go
