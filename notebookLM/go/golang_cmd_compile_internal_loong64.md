# Domain Architecture: cmd/compile/internal/loong64
...
// === FILE: references!/go/src/cmd/compile/internal/loong64/galign.go ===
```go
...
// === FILE: references!/go/src/cmd/compile/internal/loong64/ggen.go ===
```go
// Copyright 2022 The Go Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
...
// === FILE: references!/go/src/cmd/compile/internal/loong64/ssa.go ===
```go
// Copyright 2022 The Go Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
