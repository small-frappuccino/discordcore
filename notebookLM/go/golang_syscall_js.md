# Domain Architecture: syscall/js
...
// === FILE: references!/go/src/syscall/js/func.go ===
```go
...
// === FILE: references!/go/src/syscall/js/js.go ===
```go
// Copyright 2018 The Go Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
...
// === FILE: references!/go/src/syscall/js/js_js.s ===
```text
// Copyright 2018 The Go Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
