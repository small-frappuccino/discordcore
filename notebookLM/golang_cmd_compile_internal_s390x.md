# Domain Architecture: cmd/compile/internal/s390x
...
// === FILE: references/go/src/cmd/compile/internal/s390x/galign.go ===
```go
...
// === FILE: references/go/src/cmd/compile/internal/s390x/ggen.go ===
```go
// Copyright 2016 The Go Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
...
// === FILE: references/go/src/cmd/compile/internal/s390x/ssa.go ===
```go
// Copyright 2016 The Go Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
