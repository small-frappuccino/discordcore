...
// === FILE: references/go/src/slices/iter.go ===
```go
...
// === FILE: references/go/src/slices/slices.go ===
```go
...
// === FILE: references/go/src/slices/sort.go ===
```go
...
// === FILE: references/go/src/slices/zsortanyfunc.go ===
```go
...
// === FILE: references/go/src/slices/zsortordered.go ===
```go
// Code generated by gen_sort_variants.go; DO NOT EDIT.
