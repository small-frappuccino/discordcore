# Domain Architecture: cmd/compile/internal/staticdata
...
// === FILE: references/go/src/cmd/compile/internal/staticdata/data.go ===
```go
...
// === FILE: references/go/src/cmd/compile/internal/staticdata/embed.go ===
```go
